...
ride1 = Ride.new(angela, tom, 50.2)
ride2 = Ride.new(moe, larry, 25.0)
ride3 = Ride.new(oscar, tom, 30.4)
ride4 = Ride.new(angela, sally, 40.1)
ride5 = Ride.new(angela, tom, 20.7)
